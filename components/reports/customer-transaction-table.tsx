...
import type { CustomerTransactionRow } from "@/lib/reports/customer-transaction"
import { cn } from "@/lib/utils"

const COLUMN_COUNT = 4

type CustomerTransactionTableProps = {
...
export function CustomerTransactionTable({
  rows,
  rowSize,
  emptyMessage = "Select a customer to see their transactions.",
