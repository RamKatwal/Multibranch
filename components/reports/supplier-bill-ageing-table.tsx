...
import type { SupplierBillAgeingRow } from "@/lib/reports/supplier-bill-ageing"
...
type SupplierBillAgeingTableProps = {
  rows: SupplierBillAgeingRow[]
  rowSize: DataTableRowSize
  emptyMessage?: string
}

export function SupplierBillAgeingTable({
  rows,
  rowSize,
  emptyMessage = "No bills match the selected filters.",
}: SupplierBillAgeingTableProps) {
