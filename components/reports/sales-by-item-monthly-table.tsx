...
import {
  FISCAL_MONTHS,
  FISCAL_QUARTERS,
  type SalesByItemMonthlyRow,
} from "@/lib/reports/sales-by-item-monthly"
import { cn } from "@/lib/utils"

const COLUMN_COUNT = 19

type SalesByItemMonthlyTableProps = {
  rows: SalesByItemMonthlyRow[]
  rowSize: DataTableRowSize
  emptyMessage?: string
}

export function SalesByItemMonthlyTable({
  rows,
  rowSize,
  emptyMessage = "No sales recorded for this fiscal year.",
}: SalesByItemMonthlyTableProps) {
