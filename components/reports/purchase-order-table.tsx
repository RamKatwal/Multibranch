...
import type { PurchaseOrderReportRow } from "@/lib/reports/purchase-order"

const COLUMN_COUNT = 6

const COLUMNS = ["Date", "Order ID", "Supplier", "Total Amount", "Status", "Entry By"] as const
            ...
            <>
              {rows.map((row) => (
                <tr key={row.id} className={dataTableClassNames.bodyRow}>
                  ...
                  <td className={cn(bodyCell, "font-medium")}>{row.supplier}</td>
