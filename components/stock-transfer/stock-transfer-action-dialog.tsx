      ...
      <DialogContent className="sm:max-w-md">
        ...
        {isReject ? (
          <div className="flex flex-col gap-2">
            <Label htmlFor="stock-transfer-rejection-reason">
              Rejection reason <span className="text-destructive">*</span>
            </Label>
            <Textarea
              id="stock-transfer-rejection-reason"
              ...
              aria-describedby={
                reasonError ? "stock-transfer-rejection-reason-error" : undefined
              }
            />
            {reasonError ? (
              <p
                id="stock-transfer-rejection-reason-error"
